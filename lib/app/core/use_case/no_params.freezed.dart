...
abstract class _$$NoParamsImplCopyWith<$Res> {
  factory _$$NoParamsImplCopyWith(
    _$NoParamsImpl value,
    $Res Function(_$NoParamsImpl) then,
...
class __$$NoParamsImplCopyWithImpl<$Res>
  ...
  __$$NoParamsImplCopyWithImpl(
    _$NoParamsImpl _value,
    $Res Function(_$NoParamsImpl) _then,
  ) : super(_value, _then);
...
class _$NoParamsImpl implements _NoParams {
  ...
  factory _$NoParamsImpl.fromJson(Map<String, dynamic> json) =>
      _$$NoParamsImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$NoParamsImplToJson(this);
  }
}
...
abstract class _NoParams implements NoParams {
  ...
  factory _NoParams.fromJson(Map<String, dynamic> json) =
      _$NoParamsImpl.fromJson;
}
